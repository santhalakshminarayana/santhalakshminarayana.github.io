...
$$
\small{R = \int S(\lambda)\bar{r}(\lambda)d\lambda \hspace{2ex}
G = \int S(\lambda)\bar{g}(\lambda)d\lambda \hspace{2ex}
...
$$
\small{X = \int L(\lambda)\bar{x}(\lambda)d\lambda \hspace{2ex}
Y = \int L(\lambda)\bar{y}(\lambda)d\lambda \hspace{2ex}
...
$$
\small{x = \frac{X}{X + Y + Z} \hspace{2ex}
y = \frac{Y}{X + Y + Z} \hspace{2ex}
z = \frac{Z}{X + Y + Z}}
$$
