...
![Super fast Python](super-fast-python-why-python-slow/super-fast-python-why-python-slow.jpg)
...
This is the first post in the series on Python performance and Optimization. The series points out the utilization of inbuilt libraries, low-level code conversions, and other interpreters to speed-up Python. The other posts included in this series are 

- (Part-1): Why Python is slow? (this post)
- (Part-2): Good practices to write fast Python code
- (Part-3): Multi-processing and multi-tasking in Python
