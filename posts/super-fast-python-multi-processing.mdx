...
description: "Make Python computations faster by utilizing Multi-processing the correct way."
...
![Super fast Python](super-fast-python-multi-processing/super-fast-python-multi-processing.jpg)

# Super fast Python (Part-3): Multi-processing

This is the third post in the series on Python performance and Optimization. The series points out the utilization of inbuilt libraries, low-level code conversions, and other interpreters to speed-up Python. The other posts included in this series are 
...
- (Part-5): Use Numba to speed up Python Functions and Classes
...
- [Multiprocessing In Python: Core vs libraries](Multiprocessing In Python: Core vs libraries)
