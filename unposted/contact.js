...
const horizontal_break = c1 + "80",
  ...
  organization_name = c5,
  role_buffer_dot = c1;
const role_name = c4,
  role_duration = c1 + "bf",
  tech_stack_group_heading = c5,
  tech_stack_icon = c4,
  tech_stack_name = c4;
const contact_info = c4,
  mailto = c3;
      ...
      <div>
        ...
        <div className="contact-form-container">
          <p className="contact-info">
            Thank you showing for interest to contact me. You can reach me by
            filling little details below
          </p>
          <ContactForm />
        </div>
      </div>
