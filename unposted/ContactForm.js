...
const label_color = c4,
  label_required_color = c5,
  text_input_color = c4 + "e6";
const text_input_border_normal_color = c4 + "66",
  text_input_border_focus_color = c3 + "66";
const button_background = c1,
  button_color = c2,
  button_box_shadow = c4;
const button_hover_background = c4,
  button_hover_color = c4,
  button_hover_box_shadow = c2;
        ...
        .then(
          ({ status }) => {
            if (status == 200) {
              ...
              setErrMessage(
                "Oops! Something went Wrong. Please contact mailing directly or try again."
              );
              setErrMessageColor("red");
            }
          },
    ...
    <div>
      <div className="contact-form-container">
        <label className="label-name">
          Name<label className="label-name-required">*</label>
        </label>
        <input
          id="form_name"
          type="text"
        ...
        <label className="label-name">
          Email<label className="label-name-required">*</label>
        </label>
        <input
          id="form_email"
          type="text"
        ...
        <label className="label-name">
          Message<label className="label-name-required">*</label>
        </label>
        <textarea
          id="form_message"
          type="text"
        ...
        <div className="btn-container">
          <button className="btn" onClick={(e) => handleSubmitForm(e)}>
            Submit
          </button>
        </div>
      </div>
