...
const info_container_link = c4, info_container_link_hover = c3, info_container_link_active = c5, description = c1 + 'cc';
const tag_link = c4, tag_link_border = c5, tag_link_hover = c2, tag_link_hover_background = c3, tag_link_hover_border = c2;
			          ...
			          */}
			          <img src={'/images/'+metadata.metadata.imgName} alt = {metadata.metadata.title} />
				    		...
				    		<div className = 'description-container'>
				    			<Link href={`/blog/${metadata.metadata.id}`} key = {metadata.metadata.title} >
